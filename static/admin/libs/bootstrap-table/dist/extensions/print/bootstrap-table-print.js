    ...
    (function ($) {
        ...
        BootstrapTable.prototype.initToolbar = function () {
            ...
            if (this.options.showPrint) {
                ...
                if (!$print.length) {
                    $print = $(['<button class="bs-print btn btn-secondary' + sprintf(' btn-%s"', this.options.iconSize) + '  title="print" type="button">', sprintf('<i class="%s %s"></i> ', this.options.iconsPrefix, this.options.icons.print), '</button>'].join('')).appendTo($btnGroup);
