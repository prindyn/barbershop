    ...
    return function t(e, i, n) {
        ...
        3: [function(t, e, i) {
            var n = t(5)
              , a = t(2)
              , o = function(t) {
                return t instanceof o ? t : this instanceof o ? (this.valid = !1,
                this.values = {
                    rgb: [0, 0, 0],
                    hsl: [0, 0, 0],
                    hsv: [0, 0, 0],
            ...
            o.prototype.setValues = function(t, e) {
                ...
                if (o.alpha = Math.max(0, Math.min(1, void 0 === l ? o.alpha : l)),
                "alpha" === t)
                    return !1;
                for (i = 0; i < t.length; i++)
        ...
        4: [function(t, e, i) {
            ...
            function m(t) {
                ...
                e = (e = 3.2406 * a + -1.5372 * o + -.4986 * r) > .0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - .055 : e *= 12.92,
            ...
            e.exports = function(t) {
                t.controllers.bar = t.DatasetController.extend({
                    ...
                    calculateBarIndexPixels: function(t, e, i) {
                        var n, a, r, s, l, u, d, c, h, f, g, p, m, v, b, x, y, k = i.scale.options, M = "flex" === k.barThickness ? (h = e,
                        g = k,
                        m = (f = i).pixels,
                        v = m[h],
                        b = h > 0 ? m[h - 1] : null,
                        ...
                        d = a.stackCount,
                        c = a.pixels[n],
                        o.isNullOrUndef(u) ? (s = a.min * r.categoryPercentage,
                        l = r.barPercentage) : (s = u * d,
                        l = 1),
                        {
                            chunk: s / d,
                            ratio: l,
                    ...
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex]
                          ...
                          , n = t.custom || {}
                          , a = t._model;
                        a.backgroundColor = n.hoverBackgroundColor ? n.hoverBackgroundColor : o.valueAtIndexOrDefault(e.hoverBackgroundColor, i, o.getHoverColor(a.backgroundColor)),
                        a.borderColor = n.hoverBorderColor ? n.hoverBorderColor : o.valueAtIndexOrDefault(e.hoverBorderColor, i, o.getHoverColor(a.borderColor)),
                        a.borderWidth = n.hoverBorderWidth ? n.hoverBorderWidth : o.valueAtIndexOrDefault(e.hoverBorderWidth, i, a.borderWidth)
                    },
                    removeHoverStyle: function(t) {
                        ...
                        a.backgroundColor = n.backgroundColor ? n.backgroundColor : o.valueAtIndexOrDefault(e.backgroundColor, i, r.backgroundColor),
                        a.borderColor = n.borderColor ? n.borderColor : o.valueAtIndexOrDefault(e.borderColor, i, r.borderColor),
                        a.borderWidth = n.borderWidth ? n.borderWidth : o.valueAtIndexOrDefault(e.borderWidth, i, r.borderWidth)
                    }
                }),
            ...
            e.exports = function(t) {
                t.controllers.bubble = t.DatasetController.extend({
                    ...
                    _resolveElementOptions: function(t, e) {
                        var i, n, a, r = this.chart, s = r.data.datasets[this.index], l = t.custom || {}, u = r.options.elements.point, d = o.options.resolve, c = s.data[e], h = {}, f = {
                            chart: r,
                            dataIndex: e,
                            dataset: s,
                        ...
                        return h.radius = d([l.radius, c ? c.r : void 0, s.radius, u.radius], f, e),
                        h
                    }
                })
            }
                    ...
                    callbacks: {
                        ...
                        label: function(t, e) {
                            var i = e.labels[t.index]
                              , n = ": " + e.datasets[t.datasetIndex].data[t.index];
                            return o.isArray(i) ? (i = i.slice())[0] += n : i += n,
                            i
                        }
                    }
                }
            ...
            e.exports = function(t) {
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    ...
                    updateElement: function(t, e, i) {
                        ...
                        i && l.animateRotate || (b.startAngle = 0 === e ? s.rotation : n.getMeta().data[e - 1]._model.endAngle,
                    ...
                    getMaxBorderWidth: function(t) {
                        for (var e, i, n = 0, a = this.index, o = t.length, r = 0; r < o; r++)
                            ...
                            n = (i = t[r]._chart ? t[r]._chart.config.data.datasets[a].hoverBorderWidth : 0) > (n = e > n ? e : n) ? i : n;
                        return n
                    }
                })
            }
        ...
        18: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    dataElementType: a.Point,
                    update: function(t) {
                        var i, n, a, r = this, s = r.getMeta(), l = s.dataset, u = s.data || [], d = r.chart.options, c = d.elements.line, h = r.getScaleForId(s.yAxisID), f = r.getDataset(), g = e(f, d);
                        for (g && (a = l.custom || {},
                        ...
                        for (g && 0 !== l._model.tension && r.updateBezierControlPoints(),
                        i = 0,
                        n = u.length; i < n; ++i)
                            u[i].pivot()
                    },
                    getPointBackgroundColor: function(t, e) {
                        var i = this.chart.options.elements.point.backgroundColor
                          , n = this.getDataset()
                          , a = t.custom || {};
                        return a.backgroundColor ? i = a.backgroundColor : n.pointBackgroundColor ? i = o.valueAtIndexOrDefault(n.pointBackgroundColor, e, i) : n.backgroundColor && (i = n.backgroundColor),
                        i
                    },
                    getPointBorderColor: function(t, e) {
                        var i = this.chart.options.elements.point.borderColor
                          , n = this.getDataset()
                          , a = t.custom || {};
                        return a.borderColor ? i = a.borderColor : n.pointBorderColor ? i = o.valueAtIndexOrDefault(n.pointBorderColor, e, i) : n.borderColor && (i = n.borderColor),
                        i
                    },
                    getPointBorderWidth: function(t, e) {
                        var i = this.chart.options.elements.point.borderWidth
                          , n = this.getDataset()
                          , a = t.custom || {};
                        return isNaN(a.borderWidth) ? !isNaN(n.pointBorderWidth) || o.isArray(n.pointBorderWidth) ? i = o.valueAtIndexOrDefault(n.pointBorderWidth, e, i) : isNaN(n.borderWidth) || (i = n.borderWidth) : i = a.borderWidth,
                        i
                    },
                    updateElement: function(t, e, i) {
                        var n, a, r = this, s = r.getMeta(), l = t.custom || {}, u = r.getDataset(), d = r.index, c = u.data[e], h = r.getScaleForId(s.yAxisID), f = r.getScaleForId(s.xAxisID), g = r.chart.options.elements.point;
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        "monotone" === a.dataset._model.cubicInterpolationMode)
                            ...
                            e = s.length; t < e; ++t)
                                i = s[t]._model,
                                n = o.splineCurve(o.previousItem(s, t)._model, i, o.nextItem(s, t)._model, a.dataset._model.tension),
                    ...
                    draw: function() {
                        var t = this.chart
                          ...
                          , r = n.length
                          , s = 0;
                        for (o.canvas.clipArea(t.ctx, a),
                        e(this.getDataset(), t.options) && i.dataset.draw(),
                        o.canvas.unclipArea(t.ctx); s < r; ++s)
                            n[s].draw(a)
                    },
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex]
                          ...
                          , n = t.custom || {}
                          , a = t._model;
                        a.radius = n.hoverRadius || o.valueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius),
                        a.backgroundColor = n.hoverBackgroundColor || o.valueAtIndexOrDefault(e.pointHoverBackgroundColor, i, o.getHoverColor(a.backgroundColor)),
                        a.borderColor = n.hoverBorderColor || o.valueAtIndexOrDefault(e.pointHoverBorderColor, i, o.getHoverColor(a.borderColor)),
                        a.borderWidth = n.hoverBorderWidth || o.valueAtIndexOrDefault(e.pointHoverBorderWidth, i, a.borderWidth)
                    },
                    removeHoverStyle: function(t) {
                        var e = this
                        ...
                        r.radius = a.radius || o.valueAtIndexOrDefault(i.pointRadius, n, e.chart.options.elements.point.radius),
                ...
                t.controllers.radar = t.DatasetController.extend({
                    ...
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex]
                          ...
                          , n = t._index
                          , a = t._model;
                        a.radius = i.hoverRadius ? i.hoverRadius : o.valueAtIndexOrDefault(e.pointHoverRadius, n, this.chart.options.elements.point.hoverRadius),
                        a.backgroundColor = i.hoverBackgroundColor ? i.hoverBackgroundColor : o.valueAtIndexOrDefault(e.pointHoverBackgroundColor, n, o.getHoverColor(a.backgroundColor)),
                        a.borderColor = i.hoverBorderColor ? i.hoverBorderColor : o.valueAtIndexOrDefault(e.pointHoverBorderColor, n, o.getHoverColor(a.borderColor)),
                        a.borderWidth = i.hoverBorderWidth ? i.hoverBorderWidth : o.valueAtIndexOrDefault(e.pointHoverBorderWidth, n, a.borderWidth)
                    },
                    removeHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex]
                          , i = t.custom || {}
                        ...
                        a.backgroundColor = i.backgroundColor ? i.backgroundColor : o.valueAtIndexOrDefault(e.pointBackgroundColor, n, r.backgroundColor),
                        a.borderColor = i.borderColor ? i.borderColor : o.valueAtIndexOrDefault(e.pointBorderColor, n, r.borderColor),
                        a.borderWidth = i.borderWidth ? i.borderWidth : o.valueAtIndexOrDefault(e.pointBorderWidth, n, r.borderWidth)
                    }
                })
            }
        }
            ...
            e.exports = function(t) {
                ...
                a.extend(t.prototype, {
                    construct: function(e, i) {
                        ...
                        u && d ? (l.initialize(),
                        l.update()) : console.error("Failed to create chart: can't acquire context from the given item")
                    },
                    initialize: function() {
                        var t = this;
                    ...
                    buildOrUpdateControllers: function() {
                        ...
                        return a.each(e.data.datasets, function(a, o) {
                            ...
                            if (r.type && r.type !== s && (e.destroyDatasetMeta(o),
                    ...
                    update: function(e) {
                        ...
                        !1 !== l.notify(o, "beforeUpdate")) {
                            ...
                            o.updateLayout(),
                            o.options.animation && o.options.animation.duration && a.each(s, function(t) {
                                t.reset()
                            }),
                            o.updateDatasets(),
                    ...
                    draw: function(t) {
                        ...
                        e.transition(t),
                        !1 !== l.notify(e, "beforeDraw", [t]) && (a.each(e.boxes, function(t) {
                            t.draw(e.chartArea)
                        }, e),
            ...
            e.exports = function(t) {
                ...
                function i(t, i) {
                    ...
                    if (n) {
                        var a = n.listeners
                          , o = a.indexOf(i);
                        -1 !== o && a.splice(o, 1),
                        a.length > 0 || (e.forEach(function(e) {
                            delete t[e]
                        }),
                        delete t._chartjs)
                    }
                ...
                n.extend(t.DatasetController.prototype, {
                    ...
                    buildOrUpdateElements: function() {
                        ...
                        o._data !== s && (o._data && i(o._data, o),
                        a = o,
                        (t = s)._chartjs ? t._chartjs.listeners.push(a) : (Object.defineProperty(t, "_chartjs", {
                            configurable: !0,
                            enumerable: !1,
                            value: {
                                listeners: [a]
                    ...
                    removeHoverStyle: function(t, e) {
                        var i = this.chart.data.datasets[t._datasetIndex]
                          ...
                          , s = t._model;
                        s.backgroundColor = o.backgroundColor ? o.backgroundColor : r(i.backgroundColor, a, e.backgroundColor),
                    ...
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex]
                          ...
                          , r = n.getHoverColor
                          , s = t._model;
                        s.backgroundColor = a.hoverBackgroundColor ? a.hoverBackgroundColor : o(e.hoverBackgroundColor, i, r(s.backgroundColor)),
                        s.borderColor = a.hoverBorderColor ? a.hoverBorderColor : o(e.hoverBorderColor, i, r(s.borderColor)),
        ...
        26: [function(t, e, i) {
            ...
            a.extend(o.prototype, {
                ...
                pivot: function() {
                    var t = this;
                    return t._view || (t._view = a.clone(t._model)),
                    t._start = {},
                    t
                },
                transition: function(t) {
            ...
            e.exports = function(t) {
                        ...
                        merger: function(e, i, n, a) {
                            if ("xAxes" === e || "yAxes" === e) {
                                ...
                                r = 0; r < u; ++r)
                                    ...
                                    !i[e][r].type || l.type && l.type !== i[e][r].type ? o.merge(i[e][r], [t.scaleService.getScaleDefaults(s), l]) : o.merge(i[e][r], l)
                            } else
                                o._merger(e, i, n, a)
                        }
                    })
                ...
                o.splineCurveMonotone = function(t) {
                    ...
                    for (e = 0; e < h - 1; ++e)
                        n = c[e],
                        a = c[e + 1],
                        n.model.skip || a.model.skip || (o.almostEquals(n.deltaK, 0, this.EPSILON) ? n.mK = a.mK = 0 : (r = n.mK / n.deltaK,
                        s = a.mK / n.deltaK,
                        (u = Math.pow(r, 2) + Math.pow(s, 2)) <= 9 || (l = 3 / Math.sqrt(u),
                        n.mK = r * l * n.deltaK,
                        a.mK = s * l * n.deltaK)));
                    for (e = 0; e < h; ++e)
                        (n = c[e]).model.skip || (i = e > 0 ? c[e - 1] : null,
                        a = e < h - 1 ? c[e + 1] : null,
                        i && !i.model.skip && (d = (n.model.x - i.model.x) / 3,
                        n.model.controlPointPreviousX = n.model.x - d,
                        n.model.controlPointPreviousY = n.model.y - d * n.mK),
                        a && !a.model.skip && (d = (a.model.x - n.model.x) / 3,
                ...
                update: function(t, e, i) {
                    if (t) {
                        ...
                        n.each(h.concat(f, g, p), function(t) {
                            ...
                            i ? (e = t.update(t.fullWidth ? v : M, k),
                            w -= e.height) : (e = t.update(y, w),
                            M -= e.width),
                            S.push({
                                horizontal: i,
                                minSize: e,
                ...
                descriptors: function(t) {
                    ...
                    return this._plugins.concat(r.plugins || []).forEach(function(t) {
                        if (-1 === i.indexOf(t)) {
                            var e = t.id
                              , r = s[e];
                            !1 !== r && (!0 === r && (r = a.clone(n.global.plugins[e])),
                            i.push(t),
                            o.push({
                                plugin: t,
                                options: r || {}
            ...
            e.exports = function(t) {
                ...
                t.Scale = a.extend({
                    ...
                    fit: function() {
                        ...
                        if (n.width = f ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : h && c.drawTicks ? p : 0,
                        ...
                        if (u.display && h) {
                            ...
                            if (f) {
                                ...
                                0 !== t.labelRotation ? (t.paddingLeft = "bottom" === l.position ? M * S + 3 : M * x + 3,
                                t.paddingRight = "bottom" === l.position ? M * x + 3 : M * C + 3) : (t.paddingLeft = S / 2 + 3,
                    ...
                    _autoSkip: function(t) {
                        ...
                        for (l.maxTicksLimit && (a = l.maxTicksLimit),
                        s && (e = !1,
                        (h + l.autoSkipPadding) * u > r.width - (r.paddingLeft + r.paddingRight) && (e = 1 + Math.floor((h + l.autoSkipPadding) * u / (r.width - (r.paddingLeft + r.paddingRight)))),
                        ...
                        if (a.display) {
                            ...
                            if (o.each(m, function(i, n) {
                                if (!o.isNullOrUndef(i.label)) {
                                    ...
                                    n === e.zeroLineIndex && a.offset === h.offsetGridLines ? (r = h.zeroLineWidth,
                                    s = h.zeroLineColor,
                                    c = h.zeroLineBorderDash,
                                    f = h.zeroLineBorderDashOffset) : (r = o.valueAtIndexOrDefault(h.lineWidth, n),
                                    ...
                                    if (p) {
                                        var N = k + W;
                                        "bottom" === a.position ? (B = g ? "middle" : "top",
                                        z = g ? "right" : "center",
                                        R = e.top + N) : (B = g ? "middle" : "bottom",
                                        z = g ? "left" : "center",
                                        R = e.bottom - N);
                            ...
                            o.each(_, function(t) {
                                ...
                                d.display) {
                                    ...
                                    var i = t.label;
                                    if (o.isArray(i))
                                        for (var n = i.length, a = 1.5 * b.size, r = e.isHorizontal() ? 0 : -a * (n - 1) / 2, l = 0; l < n; ++l)
                                            s.fillText("" + i[l], 0, r),
                                            r += a;
                                    else
                                        s.fillText(i, 0, 0);
                            ...
                            if (h.drawBorder) {
                                ...
                                p ? (N = V = "top" === a.position ? e.bottom : e.top,
                                N += E,
                                V += E) : (B = W = "left" === a.position ? e.right : e.left,
                                B += E,
                                W += E),
                                s.beginPath(),
                                s.moveTo(B, N),
        ...
        35: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                t.Tooltip = a.extend({
                    ...
                    update: function(e) {
                        var i, n, a, s, l, u, d, c, h, f, g, p, m, v, b, x, y, k, M, w, S = this, C = S._options, _ = S._model, D = S._model = r(C), I = S._active, P = S._data, A = {
                            xAlign: _.xAlign,
                            yAlign: _.yAlign
                        }, T = {
                            x: _.x,
                        ...
                        if (I.length) {
                            ...
                            A = function(t, e) {
                                ...
                                return i.font = o.fontString(d, e._titleFontStyle, e._titleFontFamily),
                                o.each(e.title, g),
                            ...
                            v = h + f,
                            b = g + f,
                            "right" === p ? d -= s.width : "center" === p && ((d -= s.width / 2) + s.width > u.width && (d = u.width - s.width),
                            d < 0 && (d = 0)),
                            "top" === m ? c += v : c -= "bottom" === m ? s.height + v : s.height / 2,
                            "center" === m ? "left" === p ? d += v : "right" === p && (d -= v) : "left" === p ? d -= b : "right" === p && (d += b),
                            T = {
                                x: d,
                                y: c
                            }
                    ...
                    getCaretPosition: function(t, e, i) {
                        ...
                        if ("center" === h)
                            ...
                            r = s - u,
                            l = s + u);
                        else if ("left" === c ? (n = (a = f + d + u) - u,
                        o = a + u) : "right" === c ? (n = (a = f + p - d - u) - u,
                        o = a + u) : (n = (a = i.caretX) - u,
                        o = a + u),
                        "top" === h)
                            s = (r = g) - u,
                            l = r;
                    ...
                    drawTitle: function(t, i, n, a) {
                        ...
                        if (r.length) {
                            ...
                            for (n.fillStyle = e(i.titleFontColor, a),
                    ...
                    drawBody: function(t, i, n, a) {
                        ...
                        o.each(l, function(s, l) {
                            ...
                            o.each(s.lines, function(o) {
                                c && (n.fillStyle = e(i.legendColorBackground, a),
                    ...
                    handleEvent: function(t) {
                        ...
                        (e = !o.arrayEquals(i._active, i._lastActive)) && (i._lastActive = i._active,
        ...
        37: [function(t, e, i) {
            ...
            e.exports = a.extend({
                draw: function() {
                    ...
                    for (this._loop && u.length && u.push(u[0]),
                    s.save(),
                    ...
                    t = 0; t < u.length; ++t)
                        ...
                        c = t) : (i = -1 === c ? i : u[c],
                        n.skip || (c !== t - 1 && !l || -1 === c ? s.moveTo(n.x, n.y) : o.canvas.lineTo(s, i._view, e._view),
                        c = t));
                    s.stroke(),
                    s.restore()
                }
            ...
            e.exports = a.extend({
                ...
                draw: function(t) {
                    var e = this._view
                      ...
                      , c = o.color
                      , h = 0;
                    e.skip || (a.strokeStyle = e.borderColor || r,
                    a.lineWidth = o.valueOrDefault(e.borderWidth, n.global.elements.point.borderWidth),
                    a.fillStyle = e.backgroundColor || r,
                    void 0 !== t && (i.x < t.left || 1.01 * t.right < i.x || i.y < t.top || 1.01 * t.bottom < i.y) && (i.x < t.left ? h = (u - i.x) / (t.left - i.x) : 1.01 * t.right < i.x ? h = (i.x - u) / (i.x - t.right) : i.y < t.top ? h = (d - i.y) / (t.top - i.y) : 1.01 * t.bottom < i.y && (h = (i.y - d) / (i.y - t.bottom)),
        ...
        39: [function(t, e, i) {
            ...
            function r(t) {
                ...
                if (o(t)) {
                    ...
                    e = r.x - s,
                    i = r.x + s,
                    n = Math.min(r.y, r.front_base),
                    a = Math.max(r.y, r.front_base)
                } else {
                    var l = r.height / 2;
                    e = Math.min(r.x, r.front_base),
                    i = Math.max(r.x, r.front_base),
                    n = r.y - l,
                    a = r.y + l
                }
                return {
            ...
            e.exports = a.extend({
                draw: function() {
                    ...
                    if (l.horizontal ? (t = l.front_base,
                    e = l.x,
                    i = l.y - l.height / 2,
                    n = l.y + l.height / 2,
                    a = e > t ? 1 : -1,
                ...
                getCenterPoint: function() {
                    ...
                    return o(this) ? (t = i.x,
                    e = (i.y + i.front_base) / 2) : (t = (i.x + i.front_base) / 2,
                    e = i.y),
                    {
                        x: t,
                        y: e
                ...
                getArea: function() {
                    var t = this._view;
                    return t.width * Math.abs(t.y - t.front_base)
                },
                tooltipPosition: function() {
                    var t = this._view;
                    return {
        ...
        44: [function(t, e, i) {
            ...
            e.exports = {
                ...
                resolve: function(t, e, i) {
                    ...
                    for (a = 0,
                    o = t.length; a < o; ++a)
                        if (void 0 !== (r = t[a]) && (void 0 !== e && "function" == typeof r && (r = r(e)),
        ...
        47: [function(t, e, i) {
            ...
            function p(t, e, i) {
                var u, d, c, f, p, m, v, b, x = t[a] || (t[a] = {}), y = x.resizer = function(t) {
                    ...
                    return h(a, "scroll", s.bind(a, "expand")),
            ...
            function m(t) {
                ...
                delete s.resizer,
                i = (e = t)[a] || {},
                (o = i.renderProxy) && (n.each(l, function(t) {
                    f(e, t, o)
                }),
        ...
        50: [function(t, e, i) {
            ...
            e.exports = {
                ...
                afterDatasetsUpdate: function(t, e) {
                    ...
                    for (n = 0; n < g; ++n)
                        d = null,
                        (o = (i = t.getDatasetMeta(n)).dataset) && o._model && o instanceof a.Line && (d = {
                        ...
                        m.push(d);
                    for (n = 0; n < g; ++n)
                        (d = m[n]) && (d.fill = u(m, n, p),
                        d.boundary = l(d),
                        d.mapper = (void 0,
                        f = void 0,
                        h = (c = d).fill,
                        f = "dataset",
                        !1 === h ? null : (isFinite(h) || (f = "boundary"),
                        r[f](c))))
                },
                beforeDatasetDraw: function(t, e) {
                    ...
                    if (i) {
                        ...
                        u && h && l.length && (o.canvas.clipArea(a, t.chartArea),
                        function(t, e, i, n, a, o) {
                            ...
                            s = p + !!o; r < s; ++r)
                                ...
                                g = d(h),
                                f && g ? (x = v.push(u),
                                y = b.push(h)) : x && y && (m ? (f && v.push(u),
                                g && b.push(h)) : (c(t, v, b, x, y),
                                x = y = 0,
                                v = [],
                                b = []));
                            c(t, v, b, x, y),
        ...
        51: [function(t, e, i) {
            ...
            var u = a.extend({
                ...
                fit: function() {
                    var t = this
                      ...
                      , p = t.minSize
                      , m = t.isHorizontal();
                    if (m ? (p.width = t.maxWidth,
                    p.height = a ? 10 : 0) : (p.width = a ? 10 : 0,
                    ...
                    a)
                        ...
                        m) {
                            ...
                            o.each(t.legendItems, function(e, n) {
                                ...
                                v[v.length - 1] + a + i.padding >= t.width && (b += d + i.padding,
                                v[v.length] = t.left),
                                g[n] = {
                                    left: 0,
                                    top: 0,
                ...
                draw: function() {
                    var t = this
                      ...
                      , u = t.lineWidths;
                    if (e.display) {
                        var d, c = t.ctx, h = o.valueOrDefault, f = h(i.fontColor, a.defaultFontColor), g = h(i.fontSize, a.defaultFontSize), p = h(i.fontStyle, a.defaultFontStyle), m = h(i.fontFamily, a.defaultFontFamily), v = o.fontString(g, p, m);
                        c.textAlign = "left",
                        ...
                        o.each(t.legendItems, function(n, l) {
                            ...
                            y ? C + S >= s && (_ = d.y += k,
                            d.line++,
                            C = d.x = t.left + (s - u[d.line]) / 2) : _ + k > t.bottom && (C = d.x = C + t.columnWidths[d.line] + i.padding,
                            ...
                            function(t, i, n) {
                                if (!(isNaN(b) || b <= 0)) {
                                    ...
                                    if (c.setLineDash && c.setLineDash(h(n.lineDash, r.borderDash)),
            ...
            e.exports = {
                ...
                beforeUpdate: function(t) {
                    var e = t.options.legend
                      , i = t.legend;
                    e ? (o.mergeIf(e, n.global.legend),
                    i ? (r.configure(t, i, e),
                    i.options = e) : d(t, e)) : i && (r.removeBox(t, i),
                    delete t.legend)
                },
            ...
            var l = a.extend({
                ...
                draw: function() {
                    var t = this
                      ...
                      , r = n.global;
                    if (a.display) {
                        var s, l, u, d = i(a.fontSize, r.defaultFontSize), c = i(a.fontStyle, r.defaultFontStyle), h = i(a.fontFamily, r.defaultFontFamily), f = o.fontString(d, c, h), g = o.options.toLineHeight(a.lineHeight, d), p = g / 2 + a.padding, m = 0, v = t.top, b = t.left, x = t.bottom, y = t.right;
                        e.fillStyle = i(a.fontColor, r.defaultFontColor),
                        e.font = f,
                        t.isHorizontal() ? (l = b + (y - b) / 2,
                        u = v + p,
                        s = y - b) : (l = "left" === a.position ? b + p : y - p,
                        u = v + (x - v) / 2,
                        s = x - v,
                        m = Math.PI * ("left" === a.position ? -.5 : .5)),
                        e.save(),
                        e.translate(l, u),
                        e.rotate(m),
                        e.textAlign = "center",
                        ...
                        e.stacked || s) {
                            ...
                            a.each(n, function(n, o) {
                                ...
                                i.isDatasetVisible(o) && r(s) && a.each(n.data, function(i, n) {
                                    ...
                                    isNaN(a) || s.data[n].hidden || (d[n] = d[n] || 0,
                                    c[n] = c[n] || 0,
                            ...
                            a.each(n, function(e, n) {
                                ...
                                i.isDatasetVisible(n) && r(o) && a.each(e.data, function(e, i) {
                                    ...
                                    isNaN(n) || o.data[i].hidden || (null === t.min ? t.min = n : n < t.min && (t.min = n),
                    ...
                    buildTicks: function() {
                        var t = this
                          ...
                          , o = t.ticks = function(t, e) {
                            ...
                            var u = 1;
                            i < 1 && (u = Math.pow(10, i.toString().length - 2),
                            r = Math.round(r * u) / u,
                            s = Math.round(s * u) / u),
                            a.push(void 0 !== t.min ? t.min : r);
                            for (var d = 1; d < l; ++d)
                                a.push(Math.round((r + d * i) * u) / u);
                            return a.push(void 0 !== t.max ? t.max : s),
                            a
                        }(a, t);
                ...
                var e = {
                  ...
                  , i = t.Scale.extend({
                    determineDataLimits: function() {
                        ...
                        e.stacked || s) {
                            ...
                            n.each(a, function(a, o) {
                                var s = i.getDatasetMeta(o)
                                  , u = [s.type, void 0 === e.stacked && void 0 === s.stack ? o : "", s.stack].join(".");
                                i.isDatasetVisible(o) && r(s) && (void 0 === l[u] && (l[u] = []),
                                n.each(a.data, function(e, i) {
                                    var n = l[u]
                                      , a = +t.getRightValue(e);
                                    isNaN(a) || s.data[i].hidden || a < 0 || (n[i] = n[i] || 0,
                                    n[i] += a)
                                }))
                            }),
                            n.each(l, function(e) {
                            ...
                            n.each(a, function(e, a) {
                                ...
                                i.isDatasetVisible(a) && r(o) && n.each(e.data, function(e, i) {
                                    var n = +t.getRightValue(e);
                                    isNaN(n) || o.data[i].hidden || n < 0 || (null === t.min ? t.min = n : n < t.min && (t.min = n),
                                    null === t.max ? t.max = n : n > t.max && (t.max = n),
                    ...
                    buildTicks: function() {
                        var t = this
                          ...
                          , o = t.ticks = function(t, e) {
                            ...
                            o.push(s),
                            s = a * Math.pow(10, i)) : (i = Math.floor(n.log10(s)),
                            a = Math.floor(s / Math.pow(10, i)));
                            for (var d = i < 0 ? Math.pow(10, Math.abs(i)) : 1; o.push(s),
                            10 == ++a && (a = 1,
                            d = ++i >= 0 ? 1 : d),
                    ...
                    getPixelForValue: function(e) {
                        ...
                        a = u ? l.right : l.left) : (i = l.height,
                        s *= -1,
                        a = u ? l.top : l.bottom),
                        e !== o && (0 === o && (i -= h = n.getValueOrDefault(l.options.ticks.fontSize, t.defaults.global.defaultFontSize),
                        o = c),
                ...
                var c = t.LinearScaleBase.extend({
                        ...
                        a.each(e.data.datasets, function(o, r) {
                            if (e.isDatasetVisible(r)) {
                                ...
                                a.each(o.data, function(e, a) {
                                    ...
                                    isNaN(o) || s.data[a].hidden || (i = Math.min(o, i),
                                    n = Math.max(o, n))
                                })
                            }
                        }),
                    ...
                    fit: function() {
                        ...
                        this.options.pointLabels.display ? function(t) {
                            var e, i, n, o = s(t), u = Math.min(t.height / 2, t.width / 2), d = {
                                r: t.width,
                                l: 0,
                                t: t.height,
                                b: 0
                            ...
                            for (e = 0; e < p; e++) {
                                ...
                                b.start < d.l && (d.l = b.start,
                                c.l = m),
                                b.end > d.r && (d.r = b.end,
                                c.r = m),
                                x.start < d.t && (d.t = x.start,
                                c.t = m),
                                x.end > d.b && (d.b = x.end,
                                c.b = m)
                            }
                            ...
                            a.each(t.ticks, function(i, s) {
                                if (s > 0 || o.reverse) {
                                    ...
                                    if (n.display && 0 !== s && function(t, e, i, n) {
                                        var o = t.ctx;
                                        if (o.strokeStyle = a.valueAtIndexOrDefault(e.color, n - 1),
                                    ...
                                    o.display) {
                                        ...
                                        o.showLabelBackdrop) {
                                            ...
                                            d.fillRect(-g / 2 - o.backdropPaddingX, -u - h / 2 - o.backdropPaddingY, g + 2 * o.backdropPaddingX, h + 2 * o.backdropPaddingY)
                                        }
                                        d.textAlign = "center",
        ...
        58: [function(t, e, i) {
            ...
            function f(t, e) {
                var i = e.parser
                  , a = e.parser || e.format;
                return "function" == typeof i ? i(t) : "string" == typeof t && "string" == typeof a ? n(t, a) : (t instanceof n || (t = n(t)),
            ...
            function m(t, e, i, a) {
                var r, d = a.time, c = d.unit || function(t, e, i, n) {
                    ...
                    for (a = u.indexOf(t); a < d - 1; ++a)
                        if (r = (o = l[u[a]]).steps ? o.steps[o.steps.length - 1] : s,
                ...
                for (f || (f = function(t, e, i, n) {
                    ...
                    if (!c)
                        return Math.ceil(s / (n * d));
                    for (a = 0,
                    o = c.length; a < o && (r = c[a],
                    !(Math.ceil(s / (d * r)) <= n)); ++a)
                        ;
                    return r
                }(t, e, c, i)),
                ...
                r = n(b),
                m && h && !g && !d.round && (r.startOf(h),
                r.add(~~((b - r) / (v.size * f)) * f, c)); r < x; r.add(f, c))
                    y.push(+r);
                return y.push(+r),
                y
            }
            e.exports = function(t) {
                var e = t.Scale.extend({
                    ...
                    determineDataLimits: function() {
                        ...
                        for (t = 0,
                        i = f.data.labels.length; t < i; ++t)
                            k.push(g(f.data.labels[t], h));
                        for (t = 0,
                        i = (f.data.datasets || []).length; t < i; ++t)
                            if (f.isDatasetVisible(t))
                                if (l = f.data.datasets[t].data,
                                o.isObject(l[0]))
                                    for (y[t] = [],
                                    e = 0,
                                    a = l.length; e < a; ++e)
                                ...
                                y[t] = [];
                        k.length && (k = c(k).sort(d),
                        v = Math.min(v, k[0]),
                        b = Math.max(b, k[k.length - 1])),
                        x.length && (x = c(x).sort(d),
                        v = Math.min(v, x[0]),
                    ...
                    buildTicks: function() {
                        ...
                        for ("ticks" === w.bounds && C.length && (k = C[0],
                        M = C[C.length - 1]),
                        k = g(S.min, y) || k,
                        M = g(S.max, y) || M,
                        t = 0,
                        ...
                        return y.min = k,
                        y.max = M,
                        y._unit = S.unit || function(t, e, i, a) {
                        ...
                        b = 0,
                        x = 0,
                        (d = w).offset && o.length && (d.time.min || (c = o.length > 1 ? o[1] : s,
                        v = o[0],
                        b = (h(a, "time", c, "pos") - h(a, "time", v, "pos")) / 2),
                        d.time.max || (c = o[o.length - 1],
                    ...
                    getLabelForIndex: function(t, e) {
                        ...
                        return o.isObject(r) && (a = this.getRightValue(r)),
                        n.tooltipFormat ? f(a, n).format(n.tooltipFormat) : "string" == typeof a ? a : f(a, n).format(this._labelFormat)
                    },
