...
class BarberDaysSetting(models.Model):
    ...
    barber = models.ForeignKey(Barber, on_delete=models.CASCADE, verbose_name='Fryzjer, ktorego dotyczy dzien')
...
class Day(models.Model):
    ...
    day_settings = models.ForeignKey(BarberDaysSetting, on_delete=models.CASCADE, null=True, verbose_name='Ustawienia dnia')
    barber = models.ForeignKey(Barber, on_delete=models.CASCADE, verbose_name='Fryzjer, ktorego dotyczy dzien')
...
class Time(models.Model):
    ...
    day = models.ForeignKey(Day, on_delete=models.CASCADE, verbose_name='Dzien, ktorego dotyczy gogzina')
...
class ReservationDate(models.Model):
    ...
    barber = models.ForeignKey(Barber, on_delete=models.CASCADE, verbose_name='Fryzjer, ktorego dotyczy data')
    client = models.ForeignKey(Client, on_delete=models.CASCADE, verbose_name='Client, ktorego dotyczy data')
